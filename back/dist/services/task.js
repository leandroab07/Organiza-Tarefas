...
var taskService = /** @class */ (function () {
    function taskService(taskModel) {
        if (taskModel === void 0) { taskModel = new task_1["default"](connection_1["default"]); }
    ...
    taskService.prototype.getAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.taskModel.getAll()];
                    case 1:
                        result = _a.sent();
    ...
    taskService.prototype.create = function (task) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.taskModel.create(task)];
                    case 1:
                        result = _a.sent();
